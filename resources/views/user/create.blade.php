               ...
               <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{{ucfirst(substr(Route::currentRouteName(),5))}} User</h5>
                    </div>
                    <div class="ibox-content">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry..</p>


                        <form role="form" class="form-horizontal" method="post" action="/user/@yield('editid')">
                                {{csrf_field()}}
                                @section('editMethod')  
                                    @show   
                        ...
                        <div class="form-group{{ $errors->has('account_type') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control m-b" name="account_type"  required autofocus>
                                        ...
                                        <option value="{{$accounts->id}}" >{{$accounts->status_name}}</option>
                                        @endforeach
                                    </select> 
                         ...
                         <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                                    <label for="country" class="col-md-4 control-label">Country</label>
                                     ...
                                     <div class="col-md-6">
                                    <select class="form-control m-b" name="country" required autofocus>
